  ...
  return (
    <div>
      <div className="row p-3 text-center justify-content-center">
        ...
        <div className="col-md-3">
          <FaPhp size={35} color="white" />
          <p className="hard-skill-text">PHP</p>
        </div>
        <div className="col-md-3">
          <FaLaravel size={35} color="white" />
